            ...
            <section className="py-5 details" id="pizza-ingredient-details-page">
                <div className="container">
                    ...
                    <div className="item-info">
                        <p className="lead" style={{fontStyle: "italic", fontFamily: "cursive", color: "gold"}}>Burger details for :</p>
                    ...
                    <div className="row text-center">
                        {/* <ng-container *ngIf="burger?.owner == user">
                            <div className="col-lg-4 col-md-6 mb-4">                        
                                <div >
                                    <a [routerLink]="['/burgers','item', 'delete', burger?._id + '[!&%$!]' + burger?.owner + '[!&%$!]' + user]" className="btn btn-danger">Delete</a>
                                </div>
                            </div>
                        </ng-container>          */}
                    </div>
