...
export const RestaurantCreate = () => {
    ...
    const initialFormValues = { name: "", address: "", description: "", rating: "" };
    ...
    const onSubmit = (e) => {
        ...
        if(Object.values(formErrors).filter(x => x === true).length > 0){
            ...
            onRestaurantCreateFormSubmit(formValues);
            ...
            <section className="py-5" id="register-page">
                <div className="container register-page">
                    <h1 style={{fontFamily: "cursive"}}>
                        ...
                        <p className="lead" style={{fontStyle: "italic", fontFamily: "cursive"}}>Add Restaurant...</p>
                        <p> </p>
                        <p className="line"></p>
                    </h1>
                    <p>&nbsp;</p>
